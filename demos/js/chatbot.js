...
$jscomp.setPrototypeOf = "function" == typeof Object.setPrototypeOf ? Object.setPrototypeOf : $jscomp.underscoreProtoCanBeSet() ?
function(a, b) {
  a.__proto__ = b;
...
$jscomp.polyfill("Promise", function(a) {
  ...
  f.prototype.settle_ = function(a, b) {
    if (this.state_ != e.PENDING) throw Error("Cannot settle(" + a + ", " + b + "): Promise already settled in state" + this.state_);
    this.state_ = a;
    this.result_ = b;
    this.executeOnSettledCallbacks_()
  };
  f.prototype.executeOnSettledCallbacks_ =
...
module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$XhrRequest_XhrRequest.ajax = function(a, b, c, d) {
  ...
  return new Promise(function(e, f) {
    ...
    if (c && a === module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$XhrRequest_XhrRequest.Method.GET) {
      ...
      var l = 0,
          k;
      for (k in c) c.hasOwnProperty(k) && (l++ && (h += "&"), h += encodeURIComponent(k) + "=" + encodeURIComponent(c[k]))
    } else c && (d || (d = {}), d["Content-Type"] = "application/json", m = JSON.stringify(c));
    g.open(a, h);
    if (d) for (var n in d) d.hasOwnProperty(n) && g.setRequestHeader(n, d[n]);
    m ? g.send(m) : g.send();
    g.onload = function() {
...
module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$XhrRequest_XhrRequest.createXMLHTTPObject = function() {
  for (var a = null, b = 0; b < module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$XhrRequest_XhrRequest.XMLHttpFactories.length; b++) if (module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$XhrRequest_XhrRequest.XMLHttpFactories.hasOwnProperty(b)) {
    try {
...
var module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$App_App = function(a) {
  ...
  this.hanleInputKeyDown = function(a) {
    a.keyCode === module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$App_App.KEY_CODES.ENTER && (a.preventDefault(), a.stopPropagation(), b.handleInput())
  };
  this.handleInput = function() {
    var a = b.domHelper.queryInput.value;
    "" !== a.replace(/\s/g, "") && (b.domHelper.addUserRequestNode(module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$DomHelper_DomHelper.escapeString(a)), a = b.domHelper.generateEmptyServerResponseNode(), a = b.generateCallbacksForNode(a), module$exports$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$XhrRequest.XhrRequest.get(module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$App_App.API_URL, b.buildPayLoad(b.domHelper.queryInput.value)).then(a.success, a.error), b.domHelper.setInputValue("").scrollResultWrapperNodeToBottom())
  };
...
module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$App_App.prototype.initRecognition = function() {
  ...
  b.onresult = function(b) {
    for (var c = "", e = b.resultIndex; e < b.results.length; ++e) b.results[e].isFinal && (c += b.results[e][0].transcript);
